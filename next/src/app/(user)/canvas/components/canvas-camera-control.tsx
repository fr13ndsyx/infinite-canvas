    ...
    return (
        <div className="flex flex-col items-center px-5" style={{ borderLeft: separator ? "1px solid " + theme.node.stroke : undefined }}>
            ...
            <Tooltip title={tooltip} mouseEnterDelay={0.7} color={theme.node.panel} zIndex={1300}>
                <div className="relative flex h-[180px] w-full max-w-[180px] cursor-help flex-col items-center justify-between rounded-2xl border px-4 py-3 transition-colors" style={{ background: theme.toolbar.panel, borderColor: theme.node.stroke }}>
