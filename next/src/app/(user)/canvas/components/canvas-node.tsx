...
export const CanvasNode = React.memo(function CanvasNode({
    ...
    return (
        ...
        >
            ...
            {!isGroup ? (
                <>
                    <ConnectionHandleDot side="left" visible={data.type !== CanvasNodeType.Text && (hovered || isSelected || isConnecting)} onMouseDown={(event) => onConnectStart(event, data.id, "target")} />
